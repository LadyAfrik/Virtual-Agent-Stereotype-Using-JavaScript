...
SECRET_KEY = 'django-insecure-5soms!v2k@l=+1#7y+!hhg+)m9cg7j62dtroeh&z=^mtpc31s!'
...
INSTALLED_APPS = [
    ...
    'dashboard', 
    'rest_framework',  # Add directly here
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'segun',  # Replace with your MySQL password
